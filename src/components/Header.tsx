  ...
  return (
    <div className="absolute -top-0.5 w-full flex items-center justify-baseline mt-[6%]">
      ...
      <div className="absolute right-[4%] flex flex-row-reverse items-center">
        ...
        <NavLink
          to="/auth"
          className="ml-[30px] no-underline text-white pt-[9px] pb-[7px] pr-[10px] pl-[10px] border-solid border-2 border-transparent hover:border-white transition-all duration-100"
        >
          <div className="">
            AUTH
