      ...
      <div className="grid grid-cols-7 h-[130px] mb-2 mt-4">
        ...
        {genres.map((genre, index) => (
          <div
            ...
            className="border-solid border-2 rounded-md m-1 h-10 flex items-center cursor-pointer hover:bg-black hover:text-white transition-all duration-100 focus:outline-none focus:ring-2 focus:ring-blue-500" // genreBlock with focus styling
          >
